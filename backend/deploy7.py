...
# Assuming this is part of a larger FastAPI endpoint
    result_text = {
    "cancer_risk": f"{cancer_risk_percentage:.2f}%",
    "risk_level": risk_level,
    "potential_cancer_types": cancer_types_text,
    "suggestions": suggestion_text.split("\n")  # Split suggestions into a list if multi-line
    }
